...
from utils.mixup_utils import mixup_data, mixup_criterion, cutmix_data
from utils.loss_utils import LabelSmoothingCrossEntropy
from utils.data_utils import RandAugment

# from models.model import ViT
import models.model as resnet_models

model_names = sorted(name for name in resnet_models.__dict__
...
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet50_224',
                    choices=model_names,
...
parser.add_argument('--suffix', default=None, type=str, help='savedir suffix')
...
def main():
    ...
    for key in data_config:
        if isinstance(data_config[key], dict):
    ...
    args.save_dir = os.path.join(args.save_dir, 'instance_discrimination',
                                 args.dataset_name,
                                 '{}_lr_{}_wd_{}_bs_{}_epochs_{}_path_{}'.format(
                                     args.arch,
                                     args.lr,
                                     args.weight_decay,
                                     args.batch_size,
    ...
    if args.suffix:
        args.save_dir = args.save_dir+'_{}'.format(args.suffix)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = resnet_models.__dict__[args.arch](num_classes=args.num_classes,
                                            drop_path_rate=0.1)
    ...
    train_dataset = build_dataset(args, split='train', transform=train_transform)
    val_dataset = build_dataset(args, split='val', transform=val_transform)
    ...
    val_loader = torch.utils.data.DataLoader(
        val_dataset,
        batch_size=int(args.batch_size * 1.5), shuffle=False,
    ...
    wandb.init(
        ...
        name='{}_{}_lr_{}_wd_{}_bs_{}_epochs_{}_cutmix_{}_path_{}'.format(
                                     args.arch,
                                     args.input_size,
                                     args.lr,
                                     args.weight_decay,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch + 1) % args.print_freq == 0 or epoch == 0:
            ...
            if not args.multiprocessing_distributed or (args.multiprocessing_distributed
                ...
                with open(os.path.join(args.save_dir, 'valid_acc.txt'), 'a') as f1:
                    f1.write(str(validate_acc1.item()))
                    f1.write('\n')

                with open(os.path.join(args.save_dir, 'valid_losses.txt'), 'a') as f2:
                    f2.write(str(validate_loss))
                    f2.write('\n')
        ...
        wandb.log(
            {   
                ...
                "val_acc1": validate_acc1,
                "val_acc5": validate_acc5,
                "vall_loss": validate_loss
            }
        )
