...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = vit_models.__dict__[args.arch](img_size=args.input_size, embed_dim=args.embed_dim, num_classes=args.num_classes,
                                           drop_path_rate=0.1)
    ...
    wandb.init(
        ...
        name='{}_{}_lr_{}_wd_{}_bs_{}_epochs_{}_dim_{}_cutmix_{}_path_{}'.format(
                                     args.arch,
                                     args.input_size,
                                     args.lr,
                                     args.weight_decay,
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        output, feature, patch_output = model(images)
